...
@protocol SBTerminalGenericMethods

- (void) closeSaving:(SBTerminalSaveOptions)saving savingIn:(NSURL *)savingIn;  // Close a document.
...
@interface SBTerminalApplication : SBApplication

- (SBElementArray<SBTerminalWindow *> *) windows;
...
- (void) quitSaving:(SBTerminalSaveOptions)saving;  // Quit the application.
- (SBTerminalTab *) doScript:(NSString *)x in:(id)in_;  // Runs a UNIX shell script or command.

@end

// A window.
@interface SBTerminalWindow : SBObject <SBTerminalGenericMethods>

- (SBElementArray<SBTerminalTab *> *) tabs;
...
@property (copy) SBTerminalTab *selectedTab;
...
@interface SBTerminalApplication (TerminalSuite)

- (SBElementArray<SBTerminalSettingsSet *> *) settingsSets;

@property (copy) SBTerminalSettingsSet *defaultSettings;  // The settings set used for new windows.
@property (copy) SBTerminalSettingsSet *startupSettings;  // The settings set used for the window created on application startup.

@end

// A set of settings.
@interface SBTerminalSettingsSet : SBObject <SBTerminalGenericMethods>
...
// A tab.
@interface SBTerminalTab : SBObject <SBTerminalGenericMethods>
...
@property (copy) SBTerminalSettingsSet *currentSettings;  // The set of settings which control the tab’s behavior and appearance.
@property (copy) NSColor *cursorColor;  // The cursor color for the tab.
@property (copy) NSColor *backgroundColor;  // The background color for the tab.
@property (copy) NSColor *normalTextColor;  // The normal text color for the tab.
@property (copy) NSColor *boldTextColor;  // The bold text color for the tab.
