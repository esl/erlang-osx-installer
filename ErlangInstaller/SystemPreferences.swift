...
@objc public protocol SystemPreferencesApplication: SBApplicationProtocol {
    ...
    @objc optional func open(_ x: AnyObject!) -> AnyObject // Open a document.
    @objc optional func print(_ x: AnyObject!, withProperties: [AnyHashable: Any]!, printDialog: Bool) // Print a document.
    @objc optional func quitSaving(_ saving: SystemPreferencesSaveOptions) // Quit the application.
    @objc optional func exists(_ x: AnyObject!) -> Bool // Verify that an object exists.
